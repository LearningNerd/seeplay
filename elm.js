...
var $author$project$Level$levels = $elm$core$Array$fromList(
	_List_fromArray(
		[
			...
			{
			maxInterval: 1,
			rootNote: $author$project$Note$createNoteFromMidi(53)
		},
			{
			maxInterval: 2,
			rootNote: $author$project$Note$createNoteFromMidi(53)
			...
			{
			maxInterval: 1,
			rootNote: $author$project$Note$createNoteFromMidi(64)
		},
			{
			maxInterval: 2,
			rootNote: $author$project$Note$createNoteFromMidi(64)
			...
			{
			maxInterval: 1,
			rootNote: $author$project$Note$createNoteFromMidi(57)
		},
			{
			maxInterval: 2,
			rootNote: $author$project$Note$createNoteFromMidi(57)
			...
			{
			maxInterval: 1,
			rootNote: $author$project$Note$createNoteFromMidi(72)
		},
			{
			maxInterval: 2,
			rootNote: $author$project$Note$createNoteFromMidi(72)
			...
			{
			maxInterval: 1,
			rootNote: $author$project$Note$createNoteFromMidi(77)
		},
			{
			maxInterval: 2,
			rootNote: $author$project$Note$createNoteFromMidi(77)
